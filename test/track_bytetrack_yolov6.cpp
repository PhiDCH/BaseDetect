...
int main (int argc, char** argv) {
    ...
    while (cap.read(img)) {
        ...
        putText(img, format("yolov6 frame: %d fps: %d num: %d", frame_id, frame_id * 1000000 / total_ms, output_stracks.size()), Point(0, 60), 0, 2, Scalar(0, 0, 255), 6, LINE_AA);
        writer.write(img);
    }
